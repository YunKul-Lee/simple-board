...
class PostServiceTest(
    ...
    beforeSpec {
        postRepository.saveAll(
            listOf(
                Post(title = "title1", content = "content1", createdBy = "jake1"),
                Post(title = "title12", content = "content2", createdBy = "jake1"),
                Post(title = "title13", content = "content3", createdBy = "jake1"),
                Post(title = "title14", content = "content4", createdBy = "jake1"),
                Post(title = "title15", content = "content5", createdBy = "jake1"),
                Post(title = "title6", content = "content6", createdBy = "jake2"),
                Post(title = "title7", content = "content7", createdBy = "jake2"),
                Post(title = "title8", content = "content8", createdBy = "jake2"),
                Post(title = "title9", content = "content9", createdBy = "jake2"),
                Post(title = "title10", content = "content10", createdBy = "jake2")
            )
        )
    }
